  ...
  return (
    ...
    >
      <button
        ...
        className="absolute -top-2 -right-2 z-10 flex h-6 w-6 items-center justify-center rounded-full bg-gray-100 text-sm font-bold text-gray-800 transition-colors duration-200 hover:bg-gray-200"
